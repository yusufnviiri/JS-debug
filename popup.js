...
const liveButton = 'https://yusufnviiri.github.io/mobile-view/';
const codeButton = 'https://github.com/yusufnviiri/mobile-view.git';
...
<div class="content-right">
          ...
          <h2 class="mobileheadline">${project.name2}</h2>
          <div class="">
...
const mobImge = document.querySelector('.mobImag');
